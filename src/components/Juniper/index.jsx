...
const Juniper = () => (
  <div className=" projectContent">
    ...
    |{' '}
    <a href="https://juniper-ist.netlify.app/" target="_blank" rel="noreferrer">
      Demo
    </a>
    <p className="projectText">
      <strong>Goal:</strong> teaching middle-eastern youth about environmental
      problems through games.
    </p>
    <br />
    <Row>
      <Col xs={12}>
