                    ...
                    <Tab eventKey='html' title='Text'>
                        <div className='resumeHtmlContainer'>
                            ...
                            <div className='resumeHtml homeText'>
                                ...
                                <span>
                                    An educational website designed to teach
                                    youth living in MENA region about
                                    environmental issues through games.
                                </span>
                                <ul>
                                ...
                                <span>
                                    A web app designed to track and analyze diet
                                    and dietary goals
                                </span>
                                <ul>
                                ...
                                <p>
                                    ...
                                    Firebase, Git, Github, Bootstrap, Ant
                                    Design, i18next, Firebase, API usage
                                </p>
                                <h2>
                                ...
                                <ul>
                                    <li>
                                        Learned and practised HTML, CSS,
                                        JavaScript, React, Redux, Firebase, Git,
                                        Github, responsive design, AGILE etc.
                                    </li>
                                ...
                                <h4>
                                    ...
                                    >
                                        Eastern Mediterranean University Banking
                                ...
                                <ul>
                                    ...
                                    <li>
                                        5 month intense web development program
                                        run by Re:Coded with Flatiron School's
                                        curriculum.
                                    </li>
                                </ul>
                                <h4>
